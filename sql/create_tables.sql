...
\copy raw_titles (service, id, title, type, year, genre_names, user_rating, critic_score, imdb_id, tmdb_id, us_rating) FROM 'data/raw/streaming_titles_raw.csv' WITH (FORMAT csv, HEADER true, ENCODING 'utf8')
